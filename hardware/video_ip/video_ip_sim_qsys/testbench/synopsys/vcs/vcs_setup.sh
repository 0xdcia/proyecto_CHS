...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/verbosity_pkg.sv \
  $QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_utilities_pkg.sv \
  $QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_mm_pkg.sv \
  $QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/altera_merlin_slave_translator.sv \
  ...
  $QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_st_sink_interface.v \
  $QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_st_source_interface.v \
  $QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/video_effects.v \
  ...
  $QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/video_ip_sim_qsys_tb.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
