...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/verbosity_pkg.sv"                      -work altera_common_sv_packages              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_utilities_pkg.sv"               -work altera_common_sv_packages              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_mm_pkg.sv"                      -work altera_common_sv_packages              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/altera_merlin_slave_translator.sv"     -work video_effects_0_avalon_slave_translator
  ...
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_st_sink_interface.v"            -work video_effects_0                        
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_st_source_interface.v"          -work video_effects_0                        
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/video_effects.v"                       -work video_effects_0                        
  ...
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/video_ip_sim_qsys_tb.v"                                                                        
fi
