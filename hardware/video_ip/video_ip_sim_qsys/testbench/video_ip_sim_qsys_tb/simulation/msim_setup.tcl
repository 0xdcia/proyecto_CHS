...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/verbosity_pkg.sv"                                                   -work altera_common_sv_packages              
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_utilities_pkg.sv"                                            -work altera_common_sv_packages              
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_mm_pkg.sv"                                                   -work altera_common_sv_packages              
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/altera_merlin_slave_translator.sv"     -L altera_common_sv_packages -work video_effects_0_avalon_slave_translator
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_st_sink_interface.v"                                         -work video_effects_0                        
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/avalon_st_source_interface.v"                                       -work video_effects_0                        
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/submodules/video_effects.v"                                                    -work video_effects_0                        
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/video_ip_sim_qsys_tb.v"                                                                                                     
  eval  vlog -sv -L altera_common_sv_packages $USER_DEFINED_VERILOG_COMPILE_OPTIONS  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/test_program.sv"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_ip_sim_qsys_tb/simulation/top.sv"
}
